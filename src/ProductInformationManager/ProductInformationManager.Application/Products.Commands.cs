...
//
//         // Generate Sku internally
//         var nextSeq = await db.Database.SqlQueryRaw<long>("SELECT nextval('product_sku_seq')").FirstOrDefaultAsync(context.CancellationToken);
//         
//         var random = new Random();
//         var char1 = (char)random.Next('A', 'Z' + 1);
//         var char2 = (char)random.Next('A', 'Z' + 1);
//         var sku = $"{nextSeq:D8}{char1}{char2}";
//
//         var product = new Product(command.Name, sku, new CategoryId(command.CategoryId));
//
